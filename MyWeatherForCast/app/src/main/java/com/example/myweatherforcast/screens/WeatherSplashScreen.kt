package com.example.myweatherforcast.screens
...
@Composable
fun WeatherScreenSplashScreen(navController: NavHostController) {
    val scale = remember{
        Animatable(0f)
    }
    LaunchedEffect(key1 = true, block = {
        ...
        delay(2000L)
        navController.navigate(WeatherScreen.MainScreen.name+"/koblenz")
    })
